...
`isPalindrome` is expected to take in one string as its argument and return `1` for a palindrome or `0` otherwise.

## Input/Output
- Input: a string
- Output: `1` if the word passed in is a palindrome, `0` otherwise.
